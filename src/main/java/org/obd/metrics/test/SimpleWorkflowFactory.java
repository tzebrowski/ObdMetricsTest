...
public interface SimpleWorkflowFactory {
	...
	static Workflow getWorkflow(final Lifecycle lifecycle){
	...
	static Workflow getWorkflow(final DataCollector dataCollector){
		return getWorkflow(new SimpleLifecycle(), dataCollector);
	}

	static Workflow getWorkflow(Lifecycle lifecycle, DataCollector dataCollector){
